...
/**
 * @title MySmartToken
 * @dev MySmartToken is a base contract for managing a token crowdsale.
 * Crowdsales have a start and end timestamps, where investors can make
 * token purchases and the crowdsale will assign them tokens based
 * on a token per ETH rate. Funds collected are forwarded to a wallet
 * as they arrive.
 */
contract MySmartToken is StandardToken, Ownable {
  using SafeMath for uint256;

  string public constant name = "My Smart Token";
  ...
  function MySmartToken() {
      totalSupply = INITIAL_SUPPLY;
      balances[msg.sender] = INITIAL_SUPPLY;
      weiRaised = 0;
      owner = msg.sender;
      //wallet = address("0x6f82b145dc42d98ea0110750ad4fd0392a4e2603");
      site = "www.abcd.gratis";
      why = "Give a shot, take a shot.";
  }
